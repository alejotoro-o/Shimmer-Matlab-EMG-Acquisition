...
%   28/09/2011    SOH Madgwick    Initial release
    ...
    methods (Access = public)
        ...
        function obj = Update(obj, Accelerometer, Gyroscope, Magnetometer)
            ...
            h = quatmultiply(q, quatmultiply([0 Magnetometer], quatconjugate(q)));
            ...
            qDot = 0.5 * quatmultiply(q, [0 Gyroscope(1) Gyroscope(2) Gyroscope(3)]);
